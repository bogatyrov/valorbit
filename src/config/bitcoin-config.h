...
#define PACKAGE_BUGREPORT "info@valorcoin.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Valorcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Valorcoin Core 1.4.10"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "valorcoin"
