...
QVariant TransactionTableModel::txAddressDecoration(const TransactionRecord *wtx) const
{
    ...
    {
    case TransactionRecord::Generated:
        return QIcon(fUseValorTheme ? ":/icons/valor/tx_mined" : ":/icons/tx_mined");
    case TransactionRecord::RecvWithAddress:
    case TransactionRecord::RecvFromOther:
        return QIcon(fUseValorTheme ? ":/icons/valor/tx_input" : ":/icons/tx_input");
    case TransactionRecord::SendToAddress:
    case TransactionRecord::SendToOther:
        return QIcon(fUseValorTheme ? ":/icons/valor/tx_output" : ":/icons/tx_output");
    default:
        return QIcon(fUseValorTheme ? ":/icons/valor/tx_inout" : ":/icons/tx_inout");
    }
    return QVariant();
}
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::ForegroundRole:
        ...
        {
            return fUseValorTheme ? QColor(0, 255, 0) : QColor(0, 128, 0);
        }
