...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About ValorCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>ValorCoin</b> version", 0));
...
"Copyright \302\251 2014 The ValorCoin developers", 0));
