...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 VAL"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 VAL"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 VAL"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 VAL"));
