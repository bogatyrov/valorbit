...
public:
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QApplication::translate("SendCoinsDialog", "0.00 VAL", 0));
        ...
        labelCoinControlFee->setText(QApplication::translate("SendCoinsDialog", "0.00 VAL", 0));
        ...
        labelCoinControlAfterFee->setText(QApplication::translate("SendCoinsDialog", "0.00 VAL", 0));
        labelCoinControlChangeText->setText(QApplication::translate("SendCoinsDialog", "Change", 0));
        labelCoinControlChange->setText(QApplication::translate("SendCoinsDialog", "0.00 VAL", 0));
        ...
        labelBalance->setText(QApplication::translate("SendCoinsDialog", "123.456 VAL", 0));
#ifndef QT_NO_TOOLTIP
